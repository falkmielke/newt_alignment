...
- Make sure the automatic newt rotation above works consistently (angles are tricky).
- You would want to extract the crucial steps and assemble them in a function.
- Generalization is needed; especially for finding the `yellow` pattern.
- Roll out to whole folders of images.
- Explore further!
